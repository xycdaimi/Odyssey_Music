$(function(){
    ...
    var musicImgsData = ['imge/林俊杰.jpg','imge/周杰伦.jpg','imge/ge8.jpg','imge/ge6.jpg','imge/ge4.png']    // 图片地址数组
    var musicNameData = ["江南","半岛拿铁","晴天","长生诀","七里香"];                   // 歌曲名数组
    var artistNameData = ['林俊杰','周杰伦','周杰伦','西瓜JUN','周杰伦']            // 创作歌手数组
    var musicUrls=["mp3/林俊杰 - 江南.mp3","mp3/周杰伦 - 半岛铁盒 myfreemp3.vip .mp3","mp3/周杰伦 - 晴天  .mp3","mp3/长生诀.mp3",'mp3/周杰伦 - 七里香.mp3'];// 歌曲mp3数组

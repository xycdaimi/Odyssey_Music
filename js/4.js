$(function(){
    ...
    var musicNameData = ["故里","蛊梦","故人书","故人叹","光与信仰"];                   // 歌曲名数组
    var artistNameData = ['箜篌引音乐工作室','小荣同学/馒头妞','诺言Jason','西瓜jun/王胖子/排骨','血纯茗雅'] ;           // 创作歌手数组
    var musicUrls=['mp3/故里.mp3','mp3/蛊梦.mp3','mp3/故人书.mp3','mp3/故人叹.mp3','mp3/光与信仰 - 血纯茗雅.mp3'];// 歌曲mp3数组
